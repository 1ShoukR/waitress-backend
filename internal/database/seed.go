...
var mockMenuItems = map[string][]struct {
	...
	"Appetizers": {
		{RestaurantID: 1, NameOfItem: "Bruschetta", Price: 6.99, Category: "Appetizers", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1543332164-6e21c0da9852"), IsAvailable: true},
		{RestaurantID: 1, NameOfItem: "Spring Rolls", Price: 5.99, Category: "Appetizers", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1553621042-f6e147245754"), IsAvailable: true},
		{RestaurantID: 2, NameOfItem: "Caprese Salad", Price: 7.99, Category: "Appetizers", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1582599798357-034b3e220e8c"), IsAvailable: true},
		{RestaurantID: 2, NameOfItem: "Garlic Bread", Price: 4.99, Category: "Appetizers", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1600718374535-cfcb3826ef86"), IsAvailable: true},
		{RestaurantID: 3, NameOfItem: "Edamame", Price: 5.99, Category: "Appetizers", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1589308078055-98cda29db9a2"), IsAvailable: true},
		{RestaurantID: 3, NameOfItem: "Miso Soup", Price: 3.99, Category: "Appetizers", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1579935279003-f1b55a675f5b"), IsAvailable: true},
		{RestaurantID: 4, NameOfItem: "Nachos", Price: 8.99, Category: "Appetizers", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1552332386-f8dd00dc2fdf"), IsAvailable: true},
		{RestaurantID: 4, NameOfItem: "Guacamole", Price: 6.99, Category: "Appetizers", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1614729232437-9c43db997277"), IsAvailable: true},
		{RestaurantID: 5, NameOfItem: "Garlic Knots", Price: 5.99, Category: "Appetizers", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1605443809005-661ddce850db"), IsAvailable: true},
		{RestaurantID: 5, NameOfItem: "Mozzarella Sticks", Price: 7.99, Category: "Appetizers", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1587843098075-50b5f140d144"), IsAvailable: true},
		{RestaurantID: 6, NameOfItem: "Spring Rolls", Price: 5.99, Category: "Appetizers", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1553621042-f6e147245754"), IsAvailable: true},
		{RestaurantID: 6, NameOfItem: "Potstickers", Price: 6.99, Category: "Appetizers", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1600692652769-97dbaa9f076b"), IsAvailable: true},
		{RestaurantID: 7, NameOfItem: "Egg Rolls", Price: 5.99, Category: "Appetizers", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1579306503278-158e04f65a97"), IsAvailable: true},
		{RestaurantID: 7, NameOfItem: "Crab Rangoon", Price: 6.99, Category: "Appetizers", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1601924582975-a2b41e2d6b70"), IsAvailable: true},
	},
	"Mains": {
		{RestaurantID: 1, NameOfItem: "Spaghetti Carbonara", Price: 12.99, Category: "Mains", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1603133872871-1a022d1d7598"), IsAvailable: true},
		{RestaurantID: 1, NameOfItem: "Sweet and Sour Chicken", Price: 10.99, Category: "Mains", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1617196032733-ff20765f4ec4"), IsAvailable: true},
		{RestaurantID: 1, NameOfItem: "Butter Chicken", Price: 11.99, Category: "Mains", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1628599556752-57b752275e6f"), IsAvailable: true},
		{RestaurantID: 2, NameOfItem: "Lasagna", Price: 13.99, Category: "Mains", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1612197522785-f7b73361f76d"), IsAvailable: true},
		{RestaurantID: 2, NameOfItem: "Margherita Pizza", Price: 9.99, Category: "Mains", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1564936289065-7bec5e0a8679"), IsAvailable: true},
		{RestaurantID: 3, NameOfItem: "Sushi Platter", Price: 19.99, Category: "Mains", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1586796675683-cdf2694b51e3"), IsAvailable: true},
		{RestaurantID: 3, NameOfItem: "Tempura Udon", Price: 14.99, Category: "Mains", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1559925393-0d7fab0e337e"), IsAvailable: true},
		{RestaurantID: 4, NameOfItem: "Taco Platter", Price: 11.99, Category: "Mains", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1620350168245-fd442b6c68e0"), IsAvailable: true},
		{RestaurantID: 4, NameOfItem: "Burrito", Price: 9.99, Category: "Mains", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1606744825484-07a467c3cb43"), IsAvailable: true},
		{RestaurantID: 5, NameOfItem: "Pepperoni Pizza", Price: 11.99, Category: "Mains", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1580927752452-2a65d8a35d41"), IsAvailable: true},
		{RestaurantID: 5, NameOfItem: "BBQ Chicken Pizza", Price: 12.99, Category: "Mains", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1587206668054-0c6e7209f022"), IsAvailable: true},
		{RestaurantID: 6, NameOfItem: "Kung Pao Chicken", Price: 12.99, Category: "Mains", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1578663749429-360ef96e754a"), IsAvailable: true},
		{RestaurantID: 6, NameOfItem: "Beef and Broccoli", Price: 11.99, Category: "Mains", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1617204575425-2a10eab2eaf3"), IsAvailable: true},
		{RestaurantID: 7, NameOfItem: "Orange Chicken", Price: 10.99, Category: "Mains", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1612008655725-e95f6f4a2d7a"), IsAvailable: true},
		{RestaurantID: 7, NameOfItem: "General Tso's Chicken", Price: 11.99, Category: "Mains", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1608476158130-485e5361d481"), IsAvailable: true},
	},
	"Desserts": {
		{RestaurantID: 1, NameOfItem: "Tiramisu", Price: 6.99, Category: "Desserts", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1589794236195-82c16d4455a7"), IsAvailable: true},
		{RestaurantID: 1, NameOfItem: "Mango Sticky Rice", Price: 5.99, Category: "Desserts", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1578985545062-69928b1d9587"), IsAvailable: true},
		{RestaurantID: 2, NameOfItem: "Panna Cotta", Price: 7.99, Category: "Desserts", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1570197781624-a7d82cf17a0b"), IsAvailable: true},
		{RestaurantID: 2, NameOfItem: "Gelato", Price: 4.99, Category: "Desserts", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1592194996308-fd639ceef400"), IsAvailable: true},
		{RestaurantID: 3, NameOfItem: "Mochi Ice Cream", Price: 5.99, Category: "Desserts", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1578685728484-a62bb8dca36d"), IsAvailable: true},
		{RestaurantID: 3, NameOfItem: "Green Tea Cake", Price: 6.99, Category: "Desserts", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1622837276333-56005ea65832"), IsAvailable: true},
		{RestaurantID: 4, NameOfItem: "Churros", Price: 4.99, Category: "Desserts", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1612215859368-c51012b48a02"), IsAvailable: true},
		{RestaurantID: 4, NameOfItem: "Flan", Price: 5.99, Category: "Desserts", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1604335399108-ec88ddedc62e"), IsAvailable: true},
		{RestaurantID: 5, NameOfItem: "Cannoli", Price: 6.99, Category: "Desserts", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1601412436969-7c6cfa6b84e5"), IsAvailable: true},
		{RestaurantID: 5, NameOfItem: "Tartufo", Price: 7.99, Category: "Desserts", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1610018282465-4ef09aa6069e"), IsAvailable: true},
		{RestaurantID: 6, NameOfItem: "Fried Ice Cream", Price: 5.99, Category: "Desserts", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1559984802-c58c23f8f5a0"), IsAvailable: true},
		{RestaurantID: 6, NameOfItem: "Sesame Balls", Price: 4.99, Category: "Desserts", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1582057302067-4ca1a1ea6e53"), IsAvailable: true},
		{RestaurantID: 7, NameOfItem: "Fortune Cookies", Price: 2.99, Category: "Desserts", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1626986331763-2649bc2ab575"), IsAvailable: true},
		{RestaurantID: 7, NameOfItem: "Almond Cookies", Price: 3.99, Category: "Desserts", ImageURL: utilities.StringPtr("https://images.unsplash.com/photo-1590487983833-15d848a5f973"), IsAvailable: true},
	},
}
	users := []struct {
		FirstName string
